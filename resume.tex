...
\resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        {Leading the development of an ESP-32-based flight computer for a 
        student-led experimental sounding rocket, overseeing a team of 7 
        developers. Responsible for telemetry system implementation with LoRa\textsuperscript{\textcopyright}, 
        ground station integration, and flight algorithms, including apogee 
        detection via Extended Kalman Filter sensor fusion.}
    \resumeItemListEnd
