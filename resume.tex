...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
          \resumeItem{Relevant Coursework}{Object-Oriented Programming, High Performance Computing, Embedded Systems and Internet of Things, Systems Integration and Virtualization, Software Engineering}
      \resumeItemListEnd
    \resumeSubheading
...
\section{Skills}
 \resumeSubHeadingListStart
   \item{
     ...
     \item{
     \textbf{Tools}{: Git, XAMPP, Virtualization (Libvirt, Qemu, Virtualbox), JavaFX Scene Builder, Microsoft Office, Libre Office, Outlook, Mozilla Thunderbird}
     \hfill
     }
     \item{
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{\href{https://github.com/aleemont1/esiot-23-24-assignment2/}{Smart Car Washing}}
      {Group work. A Smart Car Washing prototype built with Arduino UNO.
      I engineered the architecture of the FSM, implemented the scheduler, created the APIs to run tasks and implemented the task dependency system. }
    \resumeSubItem{\href{https://github.com/progetto-oop-22-23/OOP22-HOMER}{HOMER}}
      {Group work. A smart home emulator built in Java.
      I engineered the architecture and implemented the electricity monitoring system, along with smart and automatic outlets.}
