    ...
    \item{
        \textbf{Cisco Networking Academy}
        {
            \resumeSubHeadingListStart
                ...
                \item{\href{https://github.com/aleemont1/certificates/blob/main/certificates/IOT-2018_certificate.pdf}{Introduction to the Internet of Things}}
                \item{\href{https://github.com/aleemont1/certificates/blob/main/certificates/GetConnected-2017_certificate.pdf}{Get Connected}}
            \resumeSubHeadingListEnd
        }
    }
    \item{
        ...
        {
            \resumeSubHeadingListStart
                \item{\href{https://github.com/aleemont1/certificates/blob/main/certificates/English_C1.pdf}{C1 Level Certificate}}
            \resumeSubHeadingListEnd
        }
    }
\resumeSubHeadingListEnd
